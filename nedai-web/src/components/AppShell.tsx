...
export function AppShell({
  ...
  return (
    <div className="flex flex-row h-screen w-full bg-slate-50 text-slate-900 overflow-hidden">
      {/* Sidebar - collapsible and stationary */}
      <Sidebar />
      
      {/* Main content area */}
      <div className={`flex flex-col h-full overflow-hidden relative shadow-[-4px_0_24px_rgba(0,0,0,0.02)] transition-all duration-300 ${
