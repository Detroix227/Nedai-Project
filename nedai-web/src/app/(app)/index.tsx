        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {hasConversation ? (
            ...
            <div className="h-full flex flex-col items-center justify-center px-4">
              <div className="w-[180px] h-[180px] rounded-full bg-white dark:bg-slate-800 shadow-xl shadow-blue-500/10 flex items-center justify-center mb-8 border border-slate-50 dark:border-slate-700 overflow-hidden">
                <img src="/nedai-text-logo.png" alt="NedAI" className="w-[160%] max-w-none object-contain" />
              </div>
