...
export function AppShell({
  ...
  return (
    <div className="flex flex-row h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 overflow-hidden">
      ...
      {/* Main content area */}
      <div className={`flex flex-col h-full overflow-hidden relative shadow-[-4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-[-4px_0_24px_rgba(0,0,0,0.2)] transition-all duration-300 ${
